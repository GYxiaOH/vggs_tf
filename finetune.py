"""Script to finetune vggs using Tensorflow.

Thank you for Frederik Kratzert write finetune Alexnex using tensorflow
Because my experience use a seldom framework vggs ,so i fix his code
i can use it in tensorflow with vision 1.2 or 1.4 and comes with a blog
...
with tf.Session() as sess:
    ...
    for epoch in range(num_epochs):
        ...
        for step in range(train_batches_per_epoch):
            ...
            _,l = sess.run([train_op,loss], feed_dict={x: img_batch,
                                          y: label_batch,
                                          keep_prob: dropout_rate})

            # Generate summary with the current batch of data and print current los
